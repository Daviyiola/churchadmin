      ...
      <div className="space-y-5 px-5 py-5 sm:px-6">
        ...
        {options ? <>
          ...
          {review ? <div className="rounded-3xl border border-primary/25 bg-primary/5 p-4 sm:p-5">
            ...
            <div className="mt-1 text-xs text-slate-600">{review.duplicate_count} duplicate{review.duplicate_count === 1 ? "" : "s"} removed · {review.invalid_count} invalid or unusable answer{review.invalid_count === 1 ? "" : "s"} excluded</div>
