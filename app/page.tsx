    ...
    <main className="min-h-screen bg-white text-slate-900">
      ...
      <header className="sticky top-0 z-10 border-b bg-white/80 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          ...
          <nav className="flex items-center gap-3">
            ...
            <Link href="/signin" className="text-sm font-medium text-slate-900 hover:text-slate-900">Sign in</Link>
            <Link
        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <p className="mt-4 max-w-xl text-base leading-relaxed text-slate-600">
              Track income, expenses, members, categories, attendance, reports,
              and more with clean UI and reliable workflows.
            </p>
            ...
            <div className="mt-6 text-xs text-slate-500">
              Multi-tenant ready • Themeable per church • Built for speed and
              clarity
            </div>
          </div>
      ...
      <section id="features" className="mx-auto max-w-6xl px-6 py-12">
        ...
        <p className="mt-2 max-w-2xl text-slate-600">
          Everything is designed so admins can enter data fast, avoid mistakes,
          and generate reports confidently.
        </p>
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {[
            {
              title: "Draft → Publish",
              desc: "Enter multiple records safely, review, then publish to reports.",
            },
            {
              title: "Quick Add",
              desc: "Add Members/Categories inside entry flow without breaking your rhythm.",
            },
            {
              title: "Roles & Permissions",
              desc: "Admin vs users, with audit-friendly workflows.",
            },
            {
              title: "Themeable per Church",
              desc: "Brand colors and logo can be customized per tenant.",
            },
            {
              title: "Clean Reports",
              desc: "Reports pull from published data for consistency.",
            },
            {
              title: "Modern UI",
              desc: "Tabs, cards, search, and predictable navigation.",
            },
          ].map((f) => (
